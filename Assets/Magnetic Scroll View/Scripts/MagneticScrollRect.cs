...
namespace MagneticScrollView
{
    ...
    public class MagneticScrollRect : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, /* IInitializePotentialDragHandler, */ IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        #region FIELDS
