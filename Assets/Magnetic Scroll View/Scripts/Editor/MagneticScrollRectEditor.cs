...
namespace MagneticScrollView
{
    ...
    public class MagneticScrollRectEditor : Editor
    {
        private SerializedProperty elements, viewport, indexTableManager, autoArranging, useButtons, useIndexTable, alignment, layoutMode, curvature, inertia, decelerationRate, realtimeSelection, infiniteScrolling, smoothTransition, invertOrder, useMargin, rotate, snapMode,
            resizeMode, elementsSize, elementPadding, scrollAdditionalLimits, circularFactor, distanceOffset, transitionSpeed, dragDelay, backButton, forwardButton, indexTable, onSelectionChange, onSelectionChangeDelay, onScrolling;

        private GUIContent autoArrangingButton;
        private MagneticScrollRect myTarget;
        private Mask viewportMask;
        private bool layoutSettings = true, controlSettings = true, otherSettings = true, maskViewport, showMaskGraphic;
        ...
        private void OnEnable ()
        {
            ...
            if (indexTable.objectReferenceValue == null && indexTableManager.objectReferenceValue != null)
                indexTable.objectReferenceValue = myTarget.GetComponentInChildren<IndexTableManager> ().gameObject;
