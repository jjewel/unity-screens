...
namespace MagneticScrollView
{
    ...
    public class SwipeDetectionEditor : Editor
    {
        ...
        public override void OnInspectorGUI ()
        {
            ...
            minT = Mathf.Clamp(EditorGUILayout.FloatField (minT, GUILayout.MaxWidth (38f)), 0.01f, maxT);
            EditorGUILayout.MinMaxSlider (ref minT, ref maxT, 0.01f, 1f);
            maxT = Mathf.Clamp (EditorGUILayout.FloatField (maxT, GUILayout.MaxWidth (38f)), 0.01f, 1f);
